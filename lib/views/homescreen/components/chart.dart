...
class BarChartSample1 extends StatefulWidget {
  ...
  final Color barColor = AppColors.secondaryColor;
    ...
    return AspectRatio(
      ...
      child: Stack(
        children: <Widget>[
          ...
          //     margin: const EdgeInsets.symmetric(horizontal: 20), // Add some padding
          //   ),
          // ),
        ],
      ),
        ...
        switch (i) {
          ...
          case 2:
            return makeGroupData(2, 5,
                isTouched: i == touchedIndex, barColor: Color(0xffE0AD3A));
          case 3:
